...
RFSampleF = carrierF * 100; % 43.5GHz number of samples in 1 second
duration  = numSym / baud; % length of sim in second. Will be much less than 1
RFSamples = round(duration * RFSampleF); % total number of samples for sim
