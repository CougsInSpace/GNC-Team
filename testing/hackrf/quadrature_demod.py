...
class quadrature_demod(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "quadrature_demod")
        ...
        # Blocks
        ##################################################
        self.satellites_bpsk_demodulator_0 = satellites.components.demodulators.bpsk_demodulator(baudrate = 69.25, samp_rate = samp_rate, f_offset = 0, differential = False, manchester = False, iq = True, options="")
        ...
        self.osmosdr_source_0_0.set_center_freq(433.333e6, 0)
        ...
        # Connections
        ##################################################
        self.connect((self.dc_blocker_xx_1, 0), (self.low_pass_filter_0, 0))
        self.connect((self.low_pass_filter_0, 0), (self.qtgui_time_sink_x_1, 0))
        self.connect((self.low_pass_filter_0, 0), (self.satellites_bpsk_demodulator_0, 0))
        self.connect((self.osmosdr_source_0_0, 0), (self.dc_blocker_xx_1, 0))
        self.connect((self.satellites_bpsk_demodulator_0, 0), (self.qtgui_time_sink_x_0, 0))
